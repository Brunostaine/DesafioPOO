# Projeto Diagramação de classes Iphone - POO

![Badge Status](https://img.shields.io/static/v1?label=STATUS&message=Finalizado&color=green&style=for-the-badge)

## :clipboard: Descrição

- De acordo com a diagramação criar as interfaces e classe de funcionamento do Iphone.
- Usar de Herança, polimorfismo, encapsulamento e abastração.
